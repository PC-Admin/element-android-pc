...
object VectorSettingsUrls {
    ...
    const val TAC = "https://gitlab.com/perthchat.org/legal/-/blob/main/terms-of-service.md"
    const val PRIVACY_POLICY = "https://gitlab.com/perthchat.org/legal/-/blob/main/privacy-policy.md"
